...
$rmod.def("/marko-widgets@6.0.0-rc.1/marko",{"<*>":{"@w-bind":{type:"custom","preserve-name":!0},"@w-scope":{type:"expression","preserve-name":!0},"@w-extend":{type:"custom","preserve-name":!0},"@w-config":{type:"expression","preserve-name":!0},"@w-for":{type:"custom","preserve-name":!0},"@w-id":{type:"string","preserve-name":!0},"@w-on*":{pattern:!0,type:"string","allow-expressions":!0,"preserve-name":!0,"set-flag":"hasWidgetEvents"},"@w-body":{type:"custom","preserve-name":!0},"@w-preserve":{type:"custom","preserve-name":!0},"@w-preserve-body":{type:"custom","preserve-name":!0},"@w-preserve-if":{type:"expression","preserve-name":!0},"@w-preserve-body-if":{type:"expression","preserve-name":!0},"@w-preserve-attrs":{type:"string","preserve-name":!0},transformer:"./taglib/widgets-transformer.js"},"<w-widget>":{renderer:"./taglib/widget-tag.js","@type":"object","@config":"object","@id":"string","@hasDomEvents":"number","@body":"string","var":"widget","import-var":{_cfg:"data.widgetConfig",_state:"data.widgetState",_props:"data.widgetProps",_body:"data.widgetBody"}},"<init-widgets>":{renderer:"./taglib/init-widgets-tag.js","@function-name":"string","@include-script-tag":"boolean","@immediate":"boolean"},"<w-preserve>":{renderer:"./taglib/preserve-tag.js","@id":"string","@if":"expression","@body-only":"expression"},"<widget-types>":{"code-generator":"./taglib/widget-types-tag.js","@*":"string"}});