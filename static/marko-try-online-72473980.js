...
$rmod.def("/marko-widgets@6.0.0-rc.1/taglib/helpers/widgetArgs",function(e,t,n,d,i){var g=e("/$/marko-widgets/$/raptor-util/extend"),o=n.exports=function(e,t,n,d,i,o,r){var a,s=e.data,x=s.widgetArgs;x||(null!=n&&(a=n.toString()),x=s.widgetArgs={out:e,id:a,scope:t,customEvents:d}),i&&(x.extend?x.extend.push(i):x.extend=[i]),o&&(x.extendConfig=x.extendConfig?g(o,x.extendConfig):o),r&&(x.extendState=x.extendState?g(r,x.extendState):r)};o.cleanup=function(e){delete e.data.widgetArgs}});
$rmod.def("/marko-widgets@6.0.0-rc.1/lib/widget-args-id",function(r,i,t,e,d){var n=r("../lib/repeated-id");t.exports=function(r){var i=r.id;if(i){var t=r.out,e=r.scope;if("#"===i.charAt(0))return i.substring(1);var d;return d=i.endsWith("[]")?n.nextId(t,e,i):e+"-"+i}}});
